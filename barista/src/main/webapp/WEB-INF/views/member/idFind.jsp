...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<div class="content">
		<div class="loginsearch_box">
			...
			<h4 class="bu02 tit">아이디 찾기</h4>
			<form name="frm" id="frm" method="post">
			<div class="box">
				<dl>
					<dt>이름</dt>
					<dd> <input class="input2" type="text" name="mber_name" id="mber_name"/></dd>
				...
				<div class="mT20 mB10 f12 fL full">
					...
					<button type="button" onclick="location.href='/member/pwFind'" class="btn btn_grey btn_search fR mL10">비밀번호 찾기</button>
				</div>
			</div>
			</form>
		</div>
